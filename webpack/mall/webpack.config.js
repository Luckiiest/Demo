...
module.exports = {
	...
	entry: {
		...
		orderdetail: './src/js/orderdetails.js'
	},
	//出口
	output: {
	...
	plugins:[
        ...
        new HtmlWebpackPlugin({
            template:'./goodsInfo.html', //页面模板
            filename: 'html/goodsInfo.html', //生成页面
            chunks:['goodsInfo']
        }),
        new HtmlWebpackPlugin({
            template:'./orderdetails.html', //页面模板
            filename: 'html/orderdetails.html', //生成页面
            chunks: 'orderdetails'
        }),
        //css独立打包
